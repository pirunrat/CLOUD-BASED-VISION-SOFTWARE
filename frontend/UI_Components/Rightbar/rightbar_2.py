...
class RightSidebar2(QFrame):
    ...
    def _build_ui(self):
        ...
        # --- Metric Tiles ---
        layout.addWidget(self._make_metric("Total parts inspected", "100", "#ffffff"))
        layout.addWidget(self._make_metric("Inspection rate (parts/min)", "80", "#00eaff"))
        layout.addWidget(self._make_metric("Scrap rate (R)", "7%", "#ff4444"))
        layout.addWidget(self._make_metric("Good parts rate (G)", "78%", "#44ff88"))
